...
# TODO: need to make a proper tail for my cat

# Cat
ellipse(screen, ORANGE, (330, 150, 50, 120))
ellipse(screen, BLACK, (330, 150, 50, 120), 1)

ellipse(screen, ORANGE, (70, 200, 310, 100))
ellipse(screen, BLACK, (70, 200, 310, 100), 1)
ellipse(screen, ORANGE, (90, 275, 70, 50))
ellipse(screen, BLACK, (90, 275, 70, 50), 1)
circle(screen, ORANGE,  (270,290), 50)
circle(screen, BLACK, (270, 290), 50, 1)
ellipse(screen, ORANGE, (290, 310, 30, 67))
ellipse(screen, BLACK, (290, 310, 30, 67), 1)
...
# fur ball
circle(screen, GRAY, (200, 350), 30)
arc(screen, GRAY, (70, 358, 40, 10), 0, 3.14)
arc(screen, GRAY, (110, 358, 10, 7), 3.14, 0)
arc(screen, GRAY, (119, 358, 40, 10), 0, 3.14)
arc(screen, GRAY, (160, 360, 15, 7), 3.14, 0)
arc(screen, BLACK, (180, 335, 75, 20), 1.57, 3.14)
arc(screen, BLACK, (180, 340, 75, 20), 1.57, 3.14)
